...
class tridim_nn:
    ...
    def __init__(self):
        ...
        x = Dense(400, activation='sigmoid', bias_regularizer=regularizers.l2(1e-8), kernel_regularizer=regularizers.l2(1e-8), kernel_initializer="random_normal", use_bias=True, bias_initializer='zeros')(position)
        ...
        x = Dense(400, activation='sigmoid', bias_regularizer=regularizers.l2(1e-8), kernel_regularizer=regularizers.l2(1e-8), kernel_initializer="random_normal", use_bias=True, bias_initializer='zeros')(x)
        x = Dense(400, activation='sigmoid', bias_regularizer=regularizers.l2(1e-8), kernel_regularizer=regularizers.l2(1e-8), kernel_initializer="random_normal", use_bias=True, bias_initializer='zeros')(x)
